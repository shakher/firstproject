...
<h1>Online address Book</h1>
		...
		<table border="1px";align="center"; bgcolor="green"cellpadding="20px";>
         ...
         $website=$_SESSION['website'];
         	$sql = "SELECT * FROM about where website='$website'"; 
     		...
     		while($row=mysqli_fetch_assoc($res)){
     			printf(" 
                    ...
                    $row['Address'],$row['Website'],$row['DateOfBirth'],$row['ID']); 
...
if(isset($_SESSION['website']) && isset($_POST['update']))
    {
...
<label><b>Website</b></label>
    ...
    name="birth" required>
    <input type="hidden" value="<?php echo $website ;?> " name="website">
